...
class PlayTradeTurn:
    ...
    def execute(self):
        ...
        current_player_view = self.game.get_player_view(current_player_idx)

        joint_cows = current_player_view.private.joint_cows
        ...
        enemy_idx, cow_type, cow_amount = self.player_interfaces[
            current_player_idx
        ].make_trade_decision(current_player_view, joint_cows)
