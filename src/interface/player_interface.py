...
class PlayerInterface(ABC):
    ...
    @abstractmethod
    def make_buy_back_decision(self, view: PlayerView, highest_bid: Bid) -> bool:
        """Ask bid master weather to buy the current cow using the highest bid."""
        pass

    @abstractmethod
    def choose_money_cards(
        self, view: PlayerView, highest: Bid, buyer_idx: int
    ) -> list[int]:
    ...
    # Trading
    @abstractmethod
    def make_trade_decision(self, view: PlayerView, joint_cows: list[int]) -> int:
