...
class MoneyPay:
    def optimal_pay(self, target_value: int, money_cards_amount: list[int]) -> list[int]:
        ...
        if total_money < target_value:      # This should not be possible, as payment is checked during bidding
            return None
